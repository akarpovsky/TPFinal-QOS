...
#06/30/13|10:27:14,449725 |75|37634414973|37459879005|37459879136|37634447605
	...
	#print "lista tiempos: ",lista_tiempos
...
#	print "longitud y: ", y, "longitud fitfunc: ",fitfunc
	errfunc = lambda p, x, y: fitfunc(p,x)-y

	# guess some fit parameters
	print "P_max: ",P_max,"  t_Pmax: ",t_Pmax,"   desvio: ",desvio
	p0 = scipy.c_[P_max, t_Pmax, desvio]
	print "p0: ",p0, "longitud: ",p0[0][0],p0[0][1],p0[0][2]
	...
	print "rango_ajuste: ", rango_ajuste
	for el in rango_ajuste:
		...
		#p1, success = scipy.optimize.leastsq(fitfunc, p0.copy()[0], args=(xcorr,ycorr))
	...
	p1 = almaceno_estimadores[elementos_tiempo]## p1=t_Pmax y comentar el for de leastsqr
	amp_estimada = p1[0]
	tiempo_estimado = p1[1]
	# SALIDA
